...
timeout 2h bambu $root_dir/cpu_functions/cpu_functions.cpp --clock-period=1.5 --std=c99 --top-fname=cifar10 --generate-tb=$root_dir/test.xml \
              --simulator=XSIM --experimental-setup=BAMBU-PERFORMANCE-MP "$@" > output.txt
return_value=$?
