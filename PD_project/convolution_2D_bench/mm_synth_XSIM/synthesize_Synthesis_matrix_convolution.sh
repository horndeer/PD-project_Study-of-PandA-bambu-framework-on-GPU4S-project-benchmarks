...
export PANDA_DATA_INSTALLDIR=/tmp/.mount_bambu-tRsSRK/usr/share/panda/
...
bash /home/paulevers/PD_project/PD_project/convolution_2D_bench/mm_synth_XSIM/HLS_output//Synthesis/bash_flow/bash_script.sh
