...
# Synthesis script for COMPONENT: fft_function

export PANDA_DATA_INSTALLDIR=/tmp/.mount_bambu-EtxHOn/usr/share/panda/
...
bash /home/gaetan/PD_project/PD_project/fast_fourier_transform_window_bench/mm_synth_XSIM/HLS_output//Synthesis/bash_flow_0/bash_script.sh
