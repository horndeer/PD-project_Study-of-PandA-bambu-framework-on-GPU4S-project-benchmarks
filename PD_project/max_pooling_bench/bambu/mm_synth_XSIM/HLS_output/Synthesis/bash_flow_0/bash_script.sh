...
export DESIGN_NAME="max_pooling"
: ${DESIGN_NICKNAME:=${DESIGN_NAME}}
export DESIGN_NICKNAME
export SDC_FILE=/root/Desktop/Projects/PD_project/max_pooling_bench/bambu/mm_synth_XSIM/HLS_output//Synthesis/max_pooling.sdc
export VERILOG_FILES="/root/Desktop/Projects/PD_project/max_pooling_bench/bambu/mm_synth_XSIM/max_pooling.v"
: ${FLOW_VARIANT:=base}
export FLOW_VARIANT
: ${GPL_TIMING_DRIVEN:=1}
...
proc dump_statistics {  } {
  ...
  file delete -force /root/Desktop/Projects/PD_project/max_pooling_bench/bambu/mm_synth_XSIM/HLS_output//Synthesis/bash_flow_0/max_pooling_report.xml 
  set ofile_report [open /root/Desktop/Projects/PD_project/max_pooling_bench/bambu/mm_synth_XSIM/HLS_output//Synthesis/bash_flow_0/max_pooling_report.xml w]
