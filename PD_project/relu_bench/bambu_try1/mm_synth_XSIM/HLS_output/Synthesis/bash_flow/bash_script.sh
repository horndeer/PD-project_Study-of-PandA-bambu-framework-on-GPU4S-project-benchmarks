...
export DESIGN_NAME="relu"
: ${DESIGN_NICKNAME:=${DESIGN_NAME}}
export DESIGN_NICKNAME
export SDC_FILE=/root/Desktop/Projects/PD_project/relu_bench/bambu_try1/mm_synth_XSIM/HLS_output//Synthesis/relu.sdc
export VERILOG_FILES="/root/Desktop/Projects/PD_project/relu_bench/bambu_try1/mm_synth_XSIM/relu.v"
: ${FLOW_VARIANT:=base}
export FLOW_VARIANT
: ${GPL_TIMING_DRIVEN:=1}
...
proc dump_statistics {  } {
  ...
  file delete -force /root/Desktop/Projects/PD_project/relu_bench/bambu_try1/mm_synth_XSIM/HLS_output//Synthesis/bash_flow/relu_report.xml 
  set ofile_report [open /root/Desktop/Projects/PD_project/relu_bench/bambu_try1/mm_synth_XSIM/HLS_output//Synthesis/bash_flow/relu_report.xml w]
