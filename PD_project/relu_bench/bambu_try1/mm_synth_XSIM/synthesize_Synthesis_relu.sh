...
# Synthesis script for COMPONENT: relu

export PANDA_DATA_INSTALLDIR=/tmp/.mount_bambu-wwKqUi/usr/share/panda/
export CURR_WORKDIR=/root/Desktop/Projects/PD_project/relu_bench/bambu_try1/mm_synth_XSIM
...
# STEP: bash_flow
cd /root/Desktop/Projects/PD_project/relu_bench/bambu_try1/mm_synth_XSIM
bash /root/Desktop/Projects/PD_project/relu_bench/bambu_try1/mm_synth_XSIM/HLS_output//Synthesis/bash_flow/bash_script.sh
