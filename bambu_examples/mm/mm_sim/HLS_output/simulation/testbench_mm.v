...
module mm_tb(clock);
  ...
  begin
    ...
    file = $fopen("/root/PandA-bambu-2023.1/examples/mm/mm_sim/HLS_output//simulation/values.txt","r");
    // Error in file open
    if (file == `NULL)
    begin
    ...
    res_file = $fopen("/root/PandA-bambu-2023.1/examples/mm/mm_sim/results.txt","w");
