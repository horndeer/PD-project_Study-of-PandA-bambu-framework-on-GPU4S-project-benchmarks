...
module mm_tb(clock);
  ...
  mm mm (.clock(clock), .reset(reset), .start_port(start_port), .in_a(in_a), .in_b(in_b), .out_c(out_c), .M_Rdata_ram(M_Rdata_ram), .M_DataRdy(M_DataRdy), .done_port(done_port), .Mout_oe_ram(Mout_oe_ram), .Mout_we_ram(Mout_we_ram), .Mout_addr_ram(Mout_addr_ram), .Mout_Wdata_ram(Mout_Wdata_ram), .Mout_data_ram_size(Mout_data_ram_size));
  
  // Operation to be executed just one time
  initial
  begin
    // OPEN FILE WITH VALUES FOR SIMULATION
    file = $fopen("/root/PandA-bambu-2023.1/examples/mm/mm_synth/HLS_output//simulation/values.txt","r");
    // Error in file open
    if (file == `NULL)
    begin
    ...
    res_file = $fopen("/root/PandA-bambu-2023.1/examples/mm/mm_synth/results.txt","w");
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (_bambu_testbench_mem_[(in_a - base_addr) + _i_] !== ex_in_a)
          begin
            success = 0;
          end
          _i_ = _i_ + 1;
      ...
      begin
        ...
        begin
          ...
          if (_bambu_testbench_mem_[(in_b - base_addr) + _i_] !== ex_in_b)
          begin
            success = 0;
          end
          _i_ = _i_ + 1;
      ...
      begin
        ...
        begin
          ...
          if (_bambu_testbench_mem_[(out_c - base_addr) + _i_] !== ex_out_c)
          begin
            success = 0;
          end
          _i_ = _i_ + 1;
