...
export SDC_FILE=/root/Desktop/Projects/examples/mm_float/mm_float_synth/HLS_output//Synthesis/mm.sdc
export VERILOG_FILES="/root/Desktop/Projects/examples/mm_float/mm_float_synth/mm.v"
: ${FLOW_VARIANT:=base}
export FLOW_VARIANT
: ${GPL_TIMING_DRIVEN:=1}
...
proc dump_statistics {  } {
  ...
  file delete -force /root/Desktop/Projects/examples/mm_float/mm_float_synth/HLS_output//Synthesis/bash_flow/mm_report.xml 
  set ofile_report [open /root/Desktop/Projects/examples/mm_float/mm_float_synth/HLS_output//Synthesis/bash_flow/mm_report.xml w]
