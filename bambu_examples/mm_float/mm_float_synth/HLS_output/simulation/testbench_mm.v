...
module mm_tb(clock);
  ...
  begin
    ...
    file = $fopen("/root/Desktop/Projects/examples/mm_float/mm_float_synth/HLS_output//simulation/values.txt","r");
    // Error in file open
    if (file == `NULL)
    begin
    ...
    res_file = $fopen("/root/Desktop/Projects/examples/mm_float/mm_float_synth/results.txt","w");
  ...
  begin
    ...
    begin
      ...
      if (_ch_ == "p")
      begin
        _r_ = $fscanf(file,"%b\n", in_a); // expected format: bbb...b (example: 00101110)
      end
      if (_r_ != 1) // error
      begin
        _ch_ = $fgetc(file);
      ...
      // Value for in_a found ---------------------------------------------------------------
      
      // Read a value for in_b --------------------------------------------------------------
      _ch_ = $fgetc(file);
      while (_ch_ == "/" || _ch_ == "\n")
      begin
        _r_ = $fgets(line, file);
      ...
      if (_ch_ == "p")
      begin
        _r_ = $fscanf(file,"%b\n", in_b); // expected format: bbb...b (example: 00101110)
      end
      if (_r_ != 1) // error
      begin
        _ch_ = $fgetc(file);
      ...
      // Value for in_b found ---------------------------------------------------------------
      
      // Read a value for out_c --------------------------------------------------------------
      _ch_ = $fgetc(file);
      while (_ch_ == "/" || _ch_ == "\n")
      begin
        _r_ = $fgets(line, file);
      ...
      if (_ch_ == "p")
      begin
        _r_ = $fscanf(file,"%b\n", out_c); // expected format: bbb...b (example: 00101110)
      end
      if (_r_ != 1) // error
      begin
        _ch_ = $fgetc(file);
      ...
      // Value for out_c found ---------------------------------------------------------------
      
      // Read a value for A_ROWS --------------------------------------------------------------
      _ch_ = $fgetc(file);
      while (_ch_ == "/" || _ch_ == "\n")
      begin
        _r_ = $fgets(line, file);
      ...
      if (_ch_ == "p")
      begin
        _r_ = $fscanf(file,"%b\n", A_ROWS); // expected format: bbb...b (example: 00101110)
      end
      if (_r_ != 1) // error
      begin
        _ch_ = $fgetc(file);
      ...
      // Value for A_ROWS found ---------------------------------------------------------------
      
      // Read a value for A_COLS --------------------------------------------------------------
      _ch_ = $fgetc(file);
      while (_ch_ == "/" || _ch_ == "\n")
      begin
        _r_ = $fgets(line, file);
      ...
      if (_ch_ == "p")
      begin
        _r_ = $fscanf(file,"%b\n", A_COLS); // expected format: bbb...b (example: 00101110)
      end
      if (_r_ != 1) // error
      begin
        _ch_ = $fgetc(file);
      ...
      // Value for A_COLS found ---------------------------------------------------------------
      
      // Read a value for B_COLS --------------------------------------------------------------
      _ch_ = $fgetc(file);
      while (_ch_ == "/" || _ch_ == "\n")
      begin
        _r_ = $fgets(line, file);
      ...
      if (_ch_ == "p")
      begin
        _r_ = $fscanf(file,"%b\n", B_COLS); // expected format: bbb...b (example: 00101110)
      end
      if (_r_ != 1) // error
      begin
        _ch_ = $fgetc(file);
  ...
  begin
    ...
    begin
      ...
      // OPTIONAL - Read a value for in_a --------------------------------------------------------------
      _i_ = 0;
      while (_ch_ == "/" || _ch_ == "\n" || _ch_ == "o")
      begin
        if (_ch_ == "o")
        begin
          compare_outputs = 1;
          _r_ = $fscanf(file,"%b\n", ex_in_a); // expected format: bbb...b (example: 00101110)
          if (_r_ != 1)
          begin
            // error
            $display("ERROR - Unknown error while reading the file. Character found: %c", _ch_[7:0]);
          ...
          if (compute_ulp32({_bambu_testbench_mem_[in_a + _i_*4 + 3 - base_addr], _bambu_testbench_mem_[in_a + _i_*4 + 2 - base_addr], _bambu_testbench_mem_[in_a + _i_*4 + 1 - base_addr], _bambu_testbench_mem_[in_a + _i_*4 + 0 - base_addr]}, ex_in_a) > 1)
          begin
            success = 0;
          end
          _i_ = _i_ + 1;
      ...
      // OPTIONAL - Read a value for in_b --------------------------------------------------------------
      _i_ = 0;
      while (_ch_ == "/" || _ch_ == "\n" || _ch_ == "o")
      begin
        if (_ch_ == "o")
        begin
          compare_outputs = 1;
          _r_ = $fscanf(file,"%b\n", ex_in_b); // expected format: bbb...b (example: 00101110)
          if (_r_ != 1)
          begin
            // error
            $display("ERROR - Unknown error while reading the file. Character found: %c", _ch_[7:0]);
          ...
          if (compute_ulp32({_bambu_testbench_mem_[in_b + _i_*4 + 3 - base_addr], _bambu_testbench_mem_[in_b + _i_*4 + 2 - base_addr], _bambu_testbench_mem_[in_b + _i_*4 + 1 - base_addr], _bambu_testbench_mem_[in_b + _i_*4 + 0 - base_addr]}, ex_in_b) > 1)
          begin
            success = 0;
          end
          _i_ = _i_ + 1;
      ...
      // OPTIONAL - Read a value for out_c --------------------------------------------------------------
      _i_ = 0;
      while (_ch_ == "/" || _ch_ == "\n" || _ch_ == "o")
      begin
        if (_ch_ == "o")
        begin
          compare_outputs = 1;
          _r_ = $fscanf(file,"%b\n", ex_out_c); // expected format: bbb...b (example: 00101110)
          if (_r_ != 1)
          begin
            // error
            $display("ERROR - Unknown error while reading the file. Character found: %c", _ch_[7:0]);
          ...
          if (compute_ulp32({_bambu_testbench_mem_[out_c + _i_*4 + 3 - base_addr], _bambu_testbench_mem_[out_c + _i_*4 + 2 - base_addr], _bambu_testbench_mem_[out_c + _i_*4 + 1 - base_addr], _bambu_testbench_mem_[out_c + _i_*4 + 0 - base_addr]}, ex_out_c) > 1)
          begin
            success = 0;
          end
          _i_ = _i_ + 1;
