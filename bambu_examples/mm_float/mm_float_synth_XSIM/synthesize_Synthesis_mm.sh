...
export PANDA_DATA_INSTALLDIR=/tmp/.mount_bambu-laXlp1/usr/share/panda/
export CURR_WORKDIR=/root/Desktop/Projects/bambu_examples/mm_float/mm_float_synth_XSIM
...
bash /root/Desktop/Projects/bambu_examples/mm_float/mm_float_synth_XSIM/HLS_output//Synthesis/bash_flow_2/bash_script.sh
